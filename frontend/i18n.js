...
const TRANSLATIONS = {
  en: {
    ...
    tooltipPriority: "Top Composite EV opportunity prioritized with ~15s high-frequency polling",
    action: "Action",
    symbol: "Symbol",
    price: "Price",
  ...
  ja: {
    ...
    badgePriority: "優先巡回",
    tooltipPriority: "総合期待値上位のため約15秒周期で最優先リアルタイム更新中",
    action: "アクション",
    symbol: "銘柄",
    price: "現在価格",
    change24h: "24H変動",
  ...
  zh: {
    ...
    badgePriority: "优先监控",
    tooltipPriority: "综合期望值高分标的，正以约15秒高频优先轮询更新",
    action: "操作",
    symbol: "币种",
    price: "现价",
    change24h: "24H 涨跌幅",
  ...
  ko: {
    ...
    badgePriority: "우선 갱신",
    tooltipPriority: "종합 기대치 상위 종목으로 약 15초 주기의 초고주파 우선 갱신 중",
    action: "작업",
    symbol: "종목",
    price: "현재가",
    change24h: "24H 변동률",
  ...
  es: {
    ...
    badgePriority: "Prioritario",
    tooltipPriority: "Oportunidad EV superior con sondeo prioritario de ~15s",
    action: "Acción",
    symbol: "Símbolo",
    price: "Precio",
  ...
  vi: {
    ...
    badgePriority: "Ưu tiên",
    tooltipPriority: "Cơ hội EV hàng đầu được cập nhật ưu tiên tần suất cao ~15 giây",
    action: "Thao tác",
    symbol: "Mã",
    price: "Giá",
